                                ...
                                {{--<div class="container-fluid mt-2 ">--}}
                                    {{--<form class="form-horizontal bg-transparent" method="post" action="{{route('admin.login.submit')}}">--}}
                                        ...
                                        {{--<div class="form-group  mb-5 {{ $errors->has('email') ? ' has-error' : '' }}">--}}
                                            {{--<input type="email" class="form-control input-sm input_size bg-transparent text-center shadow-none" value="{{old('email')}}" autocomplete="off" name="email" id="email" placeholder="Email" style="border: solid 2px purple;border-radius: 2rem!important;font-size: 1.4rem">--}}
                                    ...
                                    {{--</span>--}}
                                            {{--@endif--}}
                                        {{--</div>--}}
                                        {{--<span class="text-warning">@if (session('error')) {{session('error')}}  @endif</span>--}}
