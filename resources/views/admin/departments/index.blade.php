...
@section("content")
    ...
    <div class="container-fluid animated fadeInLeft">
            <div class="card shadow mb-2 mt-2" style="border-radius: 0">
                <div class="card-header custom_card_header p-0 text-center text-white"  style="border-radius: 0">
                    Add Department
                </div>
                <div class="card-block">
                    <div class="container-fluid mt-5">
                        <form class="form-horizontal " method="POST" action="{{route('post_department')}}">
                            {{csrf_field()}}
                            <div class="row mb-2">
                            <div class="form-group col-md-4 {{ $errors->has('department_name') ? ' has-error' : '' }}">
                                <input class="form-control input-sm input_size" name="department_name" id="department_name" placeholder="Department Name" style="border-radius: 2rem!important;font-size: 0.7rem">
                                <label for="department_name" class="label">Department Name</label>
