...
@section("content")
    ...
    <div class="container-fluid animated fadeInLeft">
        ...
        <div class="card  mb-2 mt-2" style="border-radius: 0">
            <div class="card-header p-0 custom_card_header text-center text-white text-lowercase"  style="border-radius: 0">Add Leave Policy</div>
                    ...
                    <form class="form-horizontal mt-5 " method="post" action="{{route('post_policy')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 mb-5 {{ $errors->has('policy') ? ' has-error' : '' }}">
                                <input class="form-control input-sm input_size " name="policy" id="policy" placeholder="policy" style="border-radius: 2rem!important;font-size: 0.7rem">
                                <label for="policy" class="label text_font">Policy</label>
                            ...
                            <div class="form-group col-md-4 mb-5 {{ $errors->has('policy') ? ' has-error' : '' }}">
                                <input class="form-control input-sm input_size " name="duration" id="duration" placeholder="Duration in days" style="border-radius: 2rem!important;font-size: 0.7rem">
                                <label for="duration" class="label text_font">Duration in days</label>
                                @if ($errors->has('duration'))
                                    <span class="help-block text-danger">
                                        <strong>{{ $errors->first('duration') }}</strong>
                                                <style>
