...
<head>
    ...
    <link href="{{ asset('css/mdb_bootstrap.min.css') }}" rel="stylesheet">

    <link href="{{ asset('css/mdb.min.css') }}" rel="stylesheet">

    <link href="{{ asset('css/jquery-ui.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/colorPick.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/colorPick.dark.theme.css') }}" rel="stylesheet">
...
// HOLIDAY SAVE
    ...
    $("#holiday_calendar").fullCalendar({
        ...
        events : [
            ...
            {
                title : '{{ $holidays->holiday_name }}',
                start : '{{ $holidays->start_date }}',
                color:      '{{ $holidays->background_color}}',
                textColor:      '{{ $holidays->text_color}}',
                borderColor: '{{ $holidays->border_color}}'
                @if ($holidays->end_date),
                end: '{{ $holidays->end_date }}',
                @endif
            },
            @endforeach
        ],
...
var sender="{{Auth::user('admin')->roles->first()->role_name}}";
...
function fetchUnreadNotifications(option=''){
    ...
    $('#department_list_card').click(function () {
        ...
        $.ajax({
            url:"{{ route('get_departments_json') }}",
            cache: false,
            type: "GET",
            dataType:'json',
            success:function (data) {
    ...
    $('#designations_list_card').click(function () {
        ...
        $.ajax({
            url:"{{ route('get_designations_json') }}",
            cache: false,
            type: "GET",
            dataType:'json',
            success:function (data) {
    ...
    $('#announcements_list_card').click(function () {
        ...
        $.ajax({
            url:"{{ route('get_announcements_json') }}",
            cache: false,
            type: "GET",
            dataType:'json',
            success:function (data) {
    ...
    $("#send_birthday_message_button").on('click',function() {
        ...
        $.post("{{ route('send_birthday') }}",{message:message,id:id}, function (data) {
    ...
    $('#add_designation_save').on('click',function() {
        ...
        $.post("{{ route('post_designation') }}",{designation:designation}, function (data) {
    ...
    $('#add_shift_save_modal').on('click',function() {
        ...
        $.post("{{ route('post_shift') }}",{shift_name:shift_name,first_half_start_time:first_half_start_time, first_half_end_time:first_half_end_time, second_half_start_time:second_half_start_time, shift_color:shift_color, second_half_end_time:second_half_end_time}, function (data) {
    ...
    $('#add_department_save').on('click',function() {
        ...
        $.post("{{ route('post_department') }}",{department_name:department_name}, function (data) {
    ...
    function fetcthDocumentsExpiry(data) {
        $.ajax({
            url: "{{ route('get_documents_expiry_dates') }}",
            method: 'GET',
            data: {column : data},
            dataType: 'json',
            success: function (data) {
