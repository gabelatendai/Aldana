...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card shadow" style="border-radius: 0">
            ...
            <div class="card-header bg-gradient-primary py-0 text-white text-center" style="border-radius: 0">Edit Company Details
            </div>

            <div class="card-block">
                <form class="form-horizontal container-fluid" action="{{route('update_company',$companyinfo->id)}}" method="Post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$companyinfo->name}}"  id="name" placeholder="Company Name">
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="motto" value="{{$companyinfo->motto}}" id="motto" placeholder="Company Motto">
                                @if ($errors->has('motto'))
                                    <span class="help-block text-danger">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="town" id="town" value="{{$companyinfo->town}}" class="form-control " placeholder="Town">
                                @if ($errors->has('town'))
                                    <span class="help-block text-danger">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="city" id="city" value="{{$companyinfo->city}}" class="form-control " placeholder="City">
                                @if ($errors->has('city'))
                                    <span class="help-block text-danger">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="code" name="code"  value="{{$companyinfo->code}}" type="text" placeholder="Post Office Box">
                                @if ($errors->has('code'))
                                    <span class="help-block text-danger">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="phone"  value="{{$companyinfo->phone}}" name="phone" type="tel" placeholder="Phone">
                                @if ($errors->has('phone'))
                                    <span class="help-block text-danger">
                                    ...
                                    <tr>
                                        <td class="photo">
                                            @if(env('APP_ENV') === 'production')
                                                <img class="student-photo" id="showPhoto" src="<?php echo asset("public/upload/logo/images/$companyinfo->photo");?>">
                                            @else
                                                <img class="student-photo" id="showPhoto" src="<?php echo asset("upload/logo/images/$companyinfo->photo");?>">
                                            @endif
                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="font-size: 12px" value="{{$companyinfo->mobile}}" name="mobile"
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" value="{{$companyinfo->email}}" name="email" id="email" placeholder="Email ">
                                @if ($errors->has('email'))
                                    <span class="help-block text-danger">
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" value="{{$companyinfo->website}}" name="website" id="website" placeholder="website">
                    ...
                    <div class="container-fluid">
                        ...
                        <button type="reset" class="btn btn-danger float-left mb-3">Cancel</button>
                    </div>
                </form>
            </div>
