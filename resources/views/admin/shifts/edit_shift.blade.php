 class="text_font"@extends("admin.layout.master")
@section("content")
    <!-- Begin Page Content -->
        ...
        <div class="card shadow mb-2" style="border-radius: 0">
            ...
            <div class="card-block">
                <div class="container-fluid">
                    <form class="form-horizontal user" method="POST" action="{{route('shift_update',$shift->id)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="row mx-auto">
                                    <div class="col-md-6 mx-auto text-center">
                                        <input type="hidden" id="shift_font" name="shift_color">
                                        <div class="colorPickSelector " id="shift_colorPickSelector" style="background-color: {{$shift->shift_color}}"><span style="color: {{$shift->color}}!important;" >Color</span></div>
                                    </div>
                                </div>
                            ...
                            @if($shift->shift_type=="split_shift")
                            <div class="col-md-10 " id="split_shift_column">
                                <input type="hidden" name="shift_radio" value="split_shift">
                                <div class="row mx-auto">
                                    <div class="col-md-3 mx-auto">
                                        <div class="form-group mx-auto {{ $errors->has('split_shift_name') ? ' has-error' : '' }}">
                                            <label for="split_shift_name text_font">Shift Name</label>
                                            <input type="text" name="split_shift_name" id="split_shift_name" value="{{$shift->shift_name}}" class="form-control py-0"  placeholder="Shift Name">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mx-auto {{ $errors->has('first_half_start_time') ? ' has-error' : '' }}">
                                            <label for="first_half_start_time text_font">First Half</label>
                                            <input type="text" name="first_half_start_time" id="first_half_start_time" value="{{$shift->first_half_start_time}}" class="form-control py-0 clockpicker"  placeholder="Start Time">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mx-auto {{ $errors->has('first_half_end_time') ? ' has-error' : '' }}">
                                            <label for="first_half_end_time text_font">First Half</label>
                                            <input type="text" name="first_half_end_time" id="first_half_end_time" value="{{$shift->first_half_end_time}}" class="form-control py-0 clockpicker"  placeholder="End Time">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mx-auto {{ $errors->has('second_half_start_time') ? ' has-error' : '' }}">
                                            <label for="second_half_start_time text_font">Second Half</label>
                                            <input type="text" name="second_half_start_time" id="second_half_start_time" value="{{$shift->second_half_start_time}}" class="form-control py-0 clockpicker"  placeholder="Start Time">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mx-auto {{ $errors->has('second_half_end_time') ? ' has-error' : '' }}">
                                            <label for="second_half_end_time text_font">Second Half</label>
                                            <input type="text" name="second_half_end_time" id="second_half_end_time" value="{{$shift->second_half_end_time}}" class="form-control py-0 clockpicker"  placeholder="End Time">
                            ...
                            @if($shift->shift_type=="full_shift")
                            <div class="col-md-10">
                                <input type="hidden" name="shift_radio" value="full_shift">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mx-auto {{ $errors->has('full_shift_name') ? ' has-error' : '' }}">
                                            <label for="shift_name text_font">Shift Name</label>
                                            <input type="text" name="full_shift_name" id="full_shift_name" value="{{$shift->shift_name}}" class="form-control py-0"  placeholder="Shift Name">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mx-auto {{ $errors->has('full_start_time') ? ' has-error' : '' }}">
                                            <label for="full_start_time text_font">Start Time</label>
                                            <input type="time" name="full_start_time" id="full_start_time" value="{{$shift->first_half_start_time}}" class="form-control py-0 clockpicker"  placeholder="Start Time">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mx-auto {{ $errors->has('full_end_time') ? ' has-error' : '' }}">
                                            <label for="full_end_time text_font">End time</label>
                                            <input type="time" name="full_end_time" id="full_end_time" class="form-control py-0 clockpicker" value="{{$shift->second_half_end_time}}"  placeholder="End Time">
            ...
            <div class="card-body border-0" >
                <div class="table-responsive text-center" style="font-size: 10px;border-radius: 0">
                    <table class="table  text-center" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                        <tr style="font-size: 14px;color: #1b1e21">
                        ...
                        @foreach($shifts as $shift)
                            <tr style="font-size: 12px;color: #1b1e21">
