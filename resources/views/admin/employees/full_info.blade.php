                ...
                <div class="classic-tabs mx-auto">
                            ...
                            <ul class="nav tabs-orange " id="myClassicTabOrange" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link shadow-none btn-hover btn-elegant" id="previousjob-tab-classic-orange" data-toggle="tab" href="#previousjob-classic-orange"
                                       role="tab" aria-controls="previousjob-classic-orange" aria-selected="false">
                                        {{--<i class="fas fa-briefcase-medical fa-2x pb-2" aria-hidden="true"></i>--}}
                                        Previous Job</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link shadow-none btn-hover btn-unique" id="trainingcouse-tab-classic-orange" data-toggle="tab" href="#trainingcouse-classic-orange"
                                       role="tab" aria-controls="trainingcouse-classic-orange" aria-selected="false">
                                        {{--<i class="fas fa-school fa-2x pb-2" aria-hidden="true"></i>--}}
                                        Training Courses</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link shadow-none btn-hover btn-pink" id="awesome-tab-classic-orange" data-toggle="tab" href="#awesome-classic-orange"
                                       role="tab" aria-controls="awesome-classic-orange" aria-selected="false">
                                        {{--<i class="fas fa-book-medical fa-2x pb-2" aria-hidden="true"></i>--}}
                                        Health Insurance</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link shadow-none btn-hover btn-purple" id="contractinfo-tab-classic-orange" data-toggle="tab" href="#contractinfo-classic-orange"
                                       role="tab" aria-controls="contractinfo-classic-orange" aria-selected="false">
                                        {{--<i class="fas fa-briefcase fa-2x pb-2" aria-hidden="true"></i>--}}
                                        Contract Info</a>
                                </li>
                                ...
                                {{--role="tab" aria-controls="awesome-classic-orange" aria-selected="false">--}}
                                {{--<i class="fas fa-flag fa-2x pb-2" aria-hidden="true"></i>--}}
                                {{--</a>--}}
                                {{--</li>--}}
                                ...
                                <li class="nav-item">
                                    <a class="nav-link shadow-none btn-hover  btn-cyan" id="emergencycontact-tab-classic-orange" data-toggle="tab" href="#emergencycontact-classic-orange"
                                       role="tab" aria-controls="emergencycontact-classic-orange" aria-selected="false">
                                        {{--<i class="fas fa-hospital fa-2x pb-2" aria-hidden="true"></i>--}}
                        ...
                        <div class="col-md-1 justify-content-center">
                            <div class="row  text-center justify-content-center">
                                @if(env('APP_ENV') === 'production')
                                    <img class=" img-fluid rounded-5" id="showPhoto"  style="width: 100px;height: 80px" src="{{asset("public/upload/employees/images/$employee->profile_photo")}}">
                                @else
                                    <img class=" img-fluid rounded-5 " id="showPhoto"  style="width: 100px;height: 80px" src="{{asset("upload/employees/images/$employee->profile_photo")}}">
                                @endif

                            </div>
                            <h6 class="text-info text-center"> {{$employee->last_name}}</h6>
                    ...
                    <div class="tab-content card border-0 " id="myClassicTabContentOrange">
                        <div class="tab-pane fade active show" id="profile-classic-orange" role="tabpanel" aria-labelledby="profile-tab-classic-orange">
                            <div class="container-fluid mt-2">
                                <div class="row text-center mx-auto">
                                    <div class="col-md-3">
                                        @if(env('APP_ENV') === 'production')
                                            <img class="  img-fluid rounded-5"  style="width: 100%;height: auto" src="{{asset("public/upload/employees/images/$employee->profile_photo")}}">
                                        @else
                                            <img class=" img-fluid  rounded-5 "  style="width: 100%;height: auto" src="{{asset("upload/employees/images/$employee->profile_photo")}}">
                                        @endif
                                    ...
                                    <div class="col-md-3">
                                        <p class="card-header text_font text-left"><i class="fa fa-user"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Family Name: &nbsp;&nbsp;  {{$employee->first_name}}</span></p>
                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-user"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Last Name: &nbsp;&nbsp;  {{$employee->last_name}}</span></p>
                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-phone"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Phone: &nbsp;&nbsp;  {{$employee->mobile_number}}</span></p>
                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-envelope"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Email: &nbsp;&nbsp;  {{$employee->email}}</span></p>

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-flag"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Nationality: &nbsp;&nbsp;  {{$employee->nationality}}</span></p>
                                    </div>

                                    <div class="col-md-3">
                                        <p class="card-header text_font text-left"><i class="fa fa-house-damage"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Department: &nbsp;&nbsp;  {{$employee->department->department_name}}</span></p>
                                        {{--@foreach($employee->designations as $designation)--}}
                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-flag"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Designation: &nbsp;&nbsp;  {{$employee->designations->first()->designation}}</span></p>

                                        {{--@endforeach--}}

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-lightbulb"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Status: &nbsp;&nbsp;  {{$employee->employee_status}}</span></p>

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Joining Date: &nbsp;&nbsp;  {{$employee->start_date}}</span></p>

                                    </div>

                                    <div class="col-md-3">
                                        <p class="card-header text_font text-left"><i class="fa fa-graduation-cap"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Education: &nbsp;&nbsp;  {{$employee->education_status}}</span></p>

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Date of Birth: &nbsp;&nbsp;  {{$employee->date_of_birth}}</span></p>

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-passport"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Passport Number: &nbsp;&nbsp;  {{$employee->passport_number}}</span></p>

                                        <hr class="bg-success">
                                        <p class="card-header text_font text-left"><i class="fa fa-passport"></i>&nbsp;&nbsp;<span class="font-weight-bolder" style="font-size: 12px">Visa Number: &nbsp;&nbsp;  {{$employee->visa_number}}</span></p>
                                    ...
                                    <table class="table text-center" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        @foreach($employee->documents as $employee_all)
                                            <tr style="font-size: 8pt">
                                                <td class="text_font text-left" >{{$employee_all->document_type}}</td>
                                                <td class="text_font  text-left" >{{$employee_all->document_scan_file}}</td>
                        ...
                        <div class="tab-pane fade" id="previousjob-classic-orange" role="tabpanel" aria-labelledby="previousjob-tab-classic-orange">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('previous_job',$employee->id)}}" method="post" class="needs-validation" novalidate>
                                            {{csrf_field()}}
                                            <div class="form-row">
                            ...
                            <div class="table-responsive text-center" style="font-size: 10px">
                                <table class="table text-center text_font" id="dataTable" width="100%" cellspacing="0" style="">
                                    ...
                                    <tbody>
                                    @foreach($employee->previousjobs as $previousjob)
                                        <tr>
                                            <td class="text_font" >{{$previousjob->company_name}}</td>
                                            <td class="text_font" >{{$previousjob->position_held}}</td>
                                            <td class="text_font" >{{$previousjob->date_left}}</td>
                                            <td class="text_font" >{{$previousjob->reason_for_leaving}}</td>
                        ...
                        <div class="tab-pane fade" id="trainingcouse-classic-orange" role="tabpanel" aria-labelledby="trainingcouse-tab-classic-orange">
                            <div class="card-body">
                                <form method="post" action="{{route('save_trainings',$employee->id)}}" class="needs-validation mb-4" novalidate>
                                    {{csrf_field()}}
                                    <div class="form-row">
                            ...
                            <div class="table-responsive text-center" style="font-size: 10px">
                                <table class="table text-center text_font" id="dataTable" width="100%" cellspacing="0" style="">
                                    ...
                                    @foreach($employee->trainings as $training)
                                        <tr>
                                            <td class="text_font" >{{$training->institute_name}}</td>
                                            <td class="text_font" >{{$training->training_subject}}</td>
                                            <td class="text_font" >{{$training->training_start_date}}</td>
                                            <td class="text_font" >{{$training->training_end_date}}</td>
                                            <td class="text_font" >{{$training->number_of_hours}}</td>
                                            <td class="text_font" >{{$training->certification}}</td>
                                            <td class="text_font" >{{$training->certificate}}</td>
                                            <td class="text_font" ><a href=""><i class="fa fa-trash-alt text-danger"></i></a></td>
                        ...
                        <div class="tab-pane fade" id="contractinfo-classic-orange" role="tabpanel" aria-labelledby="contractinfo-tab-classic-orange">
                            <div class="card-body">
                                <form method="post" action="{{route('save_contract',$employee->id)}}" class="needs-validation" novalidate>
                                    {{csrf_field()}}
                            ...
                            <div class="table-responsive text-center" style="font-size: 10px">
                                <table class="table text-center text_font" id="dataTable" width="100%" cellspacing="0" style="">
                                    ...
                                    @foreach($employee->contracts as $contract)
                                        <tr>
                                            <td class="text_font" >{{$contract->contract_type}}</td>
                                            <td class="text_font" >{{$contract->contract_start_date}}</td>
                                            <td class="text_font" >{{$contract->contract_end_date}}</td>
                                            <td class="text_font" ><a href=""><i class="fa fa-trash-alt text-danger"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                        ...
                        <div class="tab-pane fade" id="emergencycontact-classic-orange" role="tabpanel" aria-labelledby="emergencycontact-tab-classic-orange">
                            <div class="card-body">
                                <form method="post" action="{{route('save_emergency',$employee->id)}}" class="needs-validation" novalidate>
                                    {{csrf_field()}}
                            ...
                            <div class="table-responsive text-center" style="font-size: 10px">
                                <table class="table text-center text_font" id="dataTable" width="100%" cellspacing="0" style="">
                                    ...
                                    <tbody>
                                    @foreach($employee->emergencycontacts as $emergency_contact)
                                        <tr>
                                            <td class="text_font" >{{$emergency_contact->contact_person_name}}</td>
                                            <td class="text_font" >{{$emergency_contact->contact_person_phone_number}}</td>
                                            <td class="text_font" >{{$emergency_contact->contact_person_relationship}}</td>
                                            <td class="text_font" ><a href=""><i class="fa fa-trash-alt text-danger"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
