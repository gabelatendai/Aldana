...
class CreateLeavesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('leaves', function (Blueprint $table) {
            ...
            $table->string('leave_start_date')->nullable();
            $table->string('leave_end_date')->nullable();
            $table->string('leave_status')->nullable();
            $table->string('leave_description')->nullable();
            $table->string('number_of_holidays')->nullable();
            $table->string('number_of_fridays')->nullable();
