...
newMomentProto.format = function() {
	...
	if (this._ambigTime) {
		return oldMomentFormat(englishMoment(this), 'DD-MM-YYYY');
	}
	if (this._ambigZone) {
		return oldMomentFormat(englishMoment(this), 'DD-MM-YYYY[T]HH:mm:ss');
	}
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' +
					(this.isRTL ?
						titleHtml  + 'X' + + timeHtml : // put a natural space in between
						timeHtml + ' ' + titleHtml   //
						) +
				'</div>' +
