        ...
        <div class="container-fluid text-center">
                    ...
                    <div class="tab-pane fade active show" id="profile-classic-orange" role="tabpanel"
                        ...
                        <div class="container-fluid mt-2">
                            <form class="form-horizontal" id="show_attendance_byDate_form"
                                  action="<?php echo e(route('show_attendances_byDate')); ?>" method="get"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mx-auto ">
                                            <div class="form-group  text-center mx-auto">
                                                ...
                                                <input type="text" class="form-control input_size text-center py-0"
                                                       value="<?php echo e($today); ?>" required name="checkdate" placeholder="Date"
                                                       id="leave_start_date">
                                            </div>
                    ...
                    <div class="tab-pane fade show" id="profile-classic-orange " role="tabpanel"
                        ...
                        <div class="container-fluid mt-2">
                            <form class="form-horizontal" id="profile-classic-orange"
                                  action="<?php echo e(route('show_attendances_byDateRange')); ?>" method="get"
                                  enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mx-auto ">
                                            <div class="form-group  text-center mx-auto">
                                                ...
                                                <input type="text" class="form-control input_size text-center py-0"
                                                       value="<?php echo e($today); ?>" required name="checkdate_start"
            ...
            <?php if($employees): ?>
                <table class="table text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php $__currentLoopData = $names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <tr class="text_font">
                            <td><?php echo e($employee->first_name); ?>         <?php echo e($employee->last_name); ?></td>
                            <?php $__currentLoopData = $employee->checkin->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                                    <div class="box22 <?php echo e($employee->shift->shift_name); ?>"></div>
                                </td>
