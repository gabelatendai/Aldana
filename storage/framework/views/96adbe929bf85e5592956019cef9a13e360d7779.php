                       ...
                       // @if($attendances->daynum== $i)
                        ...
                        <?php $__currentLoopData = $names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="text_font">
                                ...
                                <?php $__currentLoopData = $new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($check->day_number) && $check->day_number==$employee->employee_number): ?>
                                        <?php if($employee->shift->shift_name=="red"): ?>
                                            <td><div class="box22 red"></div></td>
                                        <?php elseif($employee->shift->shift_name=="green"): ?>
                                            <td><div class="box22 green"></div></td>
                                        <?php elseif($employee->shift->shift_name=="blue"): ?>
                                            <td><div class="box22 blue"></div></td>
                                        <?php endif; ?>
                                    <?php elseif(empty($check->day_number)): ?>
                                        <td><div class="box22 black"></div></td>
                                    <?php endif; ?>
